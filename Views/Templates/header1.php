                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="<?php echo base_url; ?>Ventas">
                                ...
                                <h5> <?php if($_SESSION['rol'] != 3) {?>Ventas<?php }else{ ?>Pedido<?php }?></h5>
                            </a>
                            <?php if($_SESSION['rol'] == 1) {?>
                            ...
                            <div class="collapse" id="collapseRep" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link" href="<?php echo base_url; ?>Ventas/historial"><h6><i class="fas fa-money-check"></i> Ventas</h6></a>
